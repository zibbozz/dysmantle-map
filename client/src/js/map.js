...
const mainLayer = L.tileLayer('/assets/tiles/{z}/{x}/{y}.jpg', {
	maxNativeZoom: mapNativeMaxZoom,
	bounds: maxBoundsIsland,
	tms: false,
}).addTo(map);

const undercrownLayer = L.tileLayer('/assets/tiles_undercrown/{z}/{x}/{y}.jpg', {
	maxNativeZoom: mapNativeMaxZoom,
	minNativeZoom: 3,
	bounds: maxBoundsUndercrown,
	tms: false,
});
const dlc1Layer = L.tileLayer('/assets/tiles_dlc1/{z}/{x}/{y}.jpg', {
	maxNativeZoom: mapNativeMaxZoom,
	minNativeZoom: 3,
	bounds: maxBoundsDlc1,
	tms: false,
});
const dlc2Layer = L.tileLayer('/assets/tiles_dlc2/{z}/{x}/{y}.jpg', {
	maxNativeZoom: mapNativeMaxZoom,
	minNativeZoom: 3,
...
function getIcon(file) {
	return `<img src='/assets/images/icons/${file}.png' width='16' height='16'></img>`;
}
